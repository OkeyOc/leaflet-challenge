...
function createMap(earthquakes) {
   ...
   let streetstylemap = L.tileLayer( "https://{s}.tile.opentopomap.org/{z}/{x}/{y}.png",
   {
     attribution:
  ...
  let graymap = L.tileLayer('https://{s}.tile.opentopomap.org/{z}/{x}/{y}.png', {
    attribution: "Map data &copy; <a href=\"https://www.openstreetmap.org/\">OpenStreetMap</a> contributors, <a href=\"http://creativecommons.org/licenses/by-nc-nd/4.0/\">CC-BY-SA</a>, Imagery © <a href=\"https://www.mapbox.com/\">Mapbox</a>",
    maxZoom: 20,
